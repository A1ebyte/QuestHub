...
DROP TABLE IF EXISTS wishlist_bundles CASCADE;
DROP TABLE IF EXISTS wishlist_videojuegos CASCADE;
DROP TABLE IF EXISTS oferta_staging CASCADE;
DROP TABLE IF EXISTS bundle_productos_capturas CASCADE;
DROP TABLE IF EXISTS bundle_productos_movies CASCADE;
